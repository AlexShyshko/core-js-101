...
function timeSpanToString(startDate, endDate) {
  ...
  const hours = String(Math.trunc(diff / 3600000)).padStart(2, '0');
  diff -= 3600000 * hours;
  const mins = String(Math.trunc(diff / 60000)).padStart(2, '0');
  diff -= 60000 * mins;
  const seconds = String(Math.trunc(diff / 1000)).padStart(2, '0');
  diff -= 1000 * seconds;
  const ms = String(endDate.getMilliseconds()).padStart(3, '0');
